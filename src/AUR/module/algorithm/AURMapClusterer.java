...
public class AURMapClusterer extends StaticClustering {
        ...
        public AURMapClusterer(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
