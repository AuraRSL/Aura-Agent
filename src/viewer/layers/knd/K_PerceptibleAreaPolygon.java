...
public class K_PerceptibleAreaPolygon extends K_ViewerLayer {
    ...
    public void paint(Graphics2D g2, K_ScreenTransform kst, AURWorldGraph wsg, AURAreaGraph selected_ag) {
		...
		g2.fill(kst.getTransformedPolygon(selected_ag.getBuilding().getPerceptibleAreaPolygon()));
        g2.setColor(new Color(0, 200, 0, 100));
		g2.setStroke(new BasicStroke(2));
		g2.draw(kst.getTransformedPolygon(selected_ag.getBuilding().getPerceptibleAreaPolygon()));
    }
